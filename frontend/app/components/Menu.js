...
const IKONLAR = {
  ...
  yeni: <path d="M4 7h16M4 12h10M4 17h7M16 14l4 4m0-4-4 4" />,
  siralam: <path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" />,
...
const GRUPLAR = [
  {
    ...
    linkler: [
      ...
      { href: "/yeni-prim-sistem", ad: "Yeni Prim Sistem", ikon: "yeni" },
      { href: "/demo-magaza-eslestirme", ad: "Mağaza Eşleştirme", ikon: "siralam" },
    ],
  },
